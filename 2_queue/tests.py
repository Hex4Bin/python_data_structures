...
class TestLinkedList(TestCase):
    """ This class tests if the LinkedList class was implemented correctly. """
    ...
    def test_add_many_to_list_start(self):
        names = ("Jose", "1234-356"), ("Rolf",
                                       "2345-1-53563-2"), ("Anna", "345623-16779-3")
...
class TestQueue(TestCase):
    """ This class tests if the LinkedQueue class was implemented correctly. """
